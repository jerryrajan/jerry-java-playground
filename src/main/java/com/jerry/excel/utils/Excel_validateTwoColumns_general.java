...
public class Excel_validateTwoColumns_general {

    public static void main(String[] args) {

        try {
            boolean validationSuccessful = validateColumns("src/main/resources/Excel_validateTwoColumns_general/file1.xls", "status A",
                    "src/main/resources/Excel_validateTwoColumns_general/file2.xls", "status B","specialValidation");
